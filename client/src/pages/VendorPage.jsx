          ...
          <table className="min-w-full  text-black">
            <thead>
              <tr className=" text-left text-xs sm:text-base">
                ...
                <th className="p-3 sm:p-4 sm:text-lg hidden xl:table-cell">
                  Category
                </th>
                <th className="p-3 sm:p-4 sm:text-lg hidden sm:table-cell">
                  Address
                </th>
                ...
                <th className="p-3 sm:p-4 sm:text-lg hidden lg:table-cell">
                  Email
                </th>
