          ...
          >
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                >
                  Your comprehensive wedding planning companion that helps you
                  organize every detail of your special day—from venues to
                  vendors, guest lists to timelines.
                </p>
          ...
          >
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                >
                  Our comprehensive tools make wedding planning a joy instead of
                  a chore
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <p className="text-white">
                    Organize timelines, to-dos, and reminders with our intuitive
                    planning tools. Never miss a deadline again.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-white">
                    Find and book trusted vendors who match your style and
                    budget. Read reviews from other couples.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="py-16 px-6 md:px-12">
            ...
            >
              ...
              <p className="text-lg mb-8 max-w-xl mx-auto">
                Join thousands of happy couples who planned their perfect day
                with ease.
              </p>
